...
module RbConfig
  RUBY_VERSION.start_with?("2.3.") or
    raise "ruby lib version (2.3.6) doesn't match executable version (#{RUBY_VERSION})"

  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.3.0")
  ...
  CONFIG["rubyarchhdrdir"] = "$(DESTDIR)/usr/include/ruby-2.3.0"
  CONFIG["vendorhdrdir"] = "$(DESTDIR)/usr/include/ruby-2.3.0/vendor_ruby"
  CONFIG["sitehdrdir"] = "$(DESTDIR)/usr/local/include/ruby-2.3.0"
  CONFIG["rubyhdrdir"] = "$(DESTDIR)/usr/include/ruby-2.3.0"
  CONFIG["RUBY_SEARCH_PATH"] = ""
  CONFIG["UNIVERSAL_INTS"] = ""
  CONFIG["UNIVERSAL_ARCHNAMES"] = ""
  CONFIG["configure_args"] = " '--srcdir=/usr/src/ports/ruby/ruby-2.3.6-1.x86_64/src/ruby-2.3.6' '--prefix=/usr' '--exec-prefix=/usr' '--localstatedir=/var' '--sysconfdir=/etc' '--docdir=/usr/share/doc/ruby' '--htmldir=/usr/share/doc/ruby/html' '-C' '--with-archlibdir=/usr/lib' '--with-rubylibprefix=/usr/share/ruby/2.3.0' '--with-rubyarchprefix=/usr/lib/ruby/2.3.0' '--with-rubyhdrdir=/usr/include/ruby-2.3.0' '--with-rubyarchhdrdir=/usr/include/ruby-2.3.0' '--with-sitedir=/usr/local/share/ruby/site_ruby' '--with-sitearchdir=/usr/local/lib/ruby/site_ruby/2.3.0' '--with-sitehdrdir=/usr/local/include/ruby-2.3.0' '--with-vendordir=/usr/share/ruby/vendor_ruby' '--with-vendorarchdir=/usr/lib/ruby/vendor_ruby/2.3.0' '--with-vendorhdrdir=/usr/include/ruby-2.3.0/vendor_ruby' '--with-rubygemsdir=/usr/share/rubygems' '--with-ruby-version=' '--disable-multiarch' '--enable-shared' 'LDSHARED=gcc -shared' 'DLDFLAGS=-Wl,--export-all-symbols' 'CC=gcc' 'CFLAGS=-ggdb -O2 -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4  ' 'LDFLAGS=' 'LIBS=' 'CPPFLAGS=' 'CXX=g++' 'CXXFLAGS=-ggdb -O2 -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4  '"
  CONFIG["CONFIGURE"] = "configure"
  CONFIG["rubygemsdir"] = "$(DESTDIR)/usr/share/rubygems"
  CONFIG["vendorarchdir"] = "$(DESTDIR)/usr/lib/ruby/vendor_ruby/2.3.0"
  CONFIG["vendorlibdir"] = "$(vendordir)"
  CONFIG["vendordir"] = "$(DESTDIR)/usr/share/ruby/vendor_ruby"
  CONFIG["sitearchdir"] = "$(DESTDIR)/usr/local/lib/ruby/site_ruby/2.3.0"
  ...
  CONFIG["rubylibprefix"] = "$(exec_prefix)/share/ruby/2.3.0"
  CONFIG["setup"] = "Setup"
  CONFIG["ENCSTATIC"] = ""
  CONFIG["EXTSTATIC"] = ""
  CONFIG["STRIP"] = "strip"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-ggdb -O2 -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4  "
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fstack-protector"
  CONFIG["CFLAGS"] = "-ggdb -O2 -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4  "
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "gcc"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.3.6"
